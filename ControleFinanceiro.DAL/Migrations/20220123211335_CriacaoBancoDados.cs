    ...
    public partial class CriacaoBancoDados : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CataoId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Nome = table.Column<string>(maxLength: 20, nullable: false),
                    Bandeira = table.Column<string>(maxLength: 30, nullable: false),
                    Numero = table.Column<string>(maxLength: 20, nullable: false),
                    Limite = table.Column<double>(nullable: false),
                    UsiarioId = table.Column<string>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Cartoes", x => x.CataoId);
                    table.ForeignKey(
                        name: "FK_Cartoes_Usuarios_UsiarioId",
                        column: x => x.UsiarioId,
                        principalTable: "Usuarios",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "e1d20f23-4b47-487e-b93e-c0da65bc4c4e", "00f8a403-c5c5-4bd6-b6f8-1daa80f5238d", "Administrador do sistema", "Administrador", "ADMINISTRADOR" },
                    { "e70f808c-55b2-4d3e-b62f-8410f5741f64", "089f31ec-b1c8-4bed-b92a-d6816473f1cd", "Usuario do sistema", "Usuario", "USUARIO" }
                });
